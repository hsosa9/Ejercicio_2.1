...
import com.example.ejercicio_21.transacciones.transacciones;
        ...
        btnguardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (requestCode == GALLERY_INTENT && resultCode == RESULT_OK){
                    ...
                    Toast.makeText(getApplicationContext(), "Almacenado con exito" +" "+ "Numero "+resultado, Toast.LENGTH_LONG).show();
                    db.close();
                }
            }
        });
